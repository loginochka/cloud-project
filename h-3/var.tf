...
variable "alb-healthcheck-time" {
  type    = list(string)
  default = ["15s", "60s"]
}
variable "alb-http-backend-name" {
  type    = list(string)
  default = ["web-http-backend"]
}
variable "alb-backend-name" {
  type    = list(string)
  default = ["web-http-backend"]
}
variable "alb-web-route-name" {
  type    = list(string)
  default = ["web-router"]
}
variable "alb-virtual-host-route-name" {
  type    = list(string)
  default = ["alb-web-vh-for-lamp"]
}
variable "alb-http-route-timeout" {
  type    = list(string)
  default = ["60s"]
}
variable "alb-virtual-host-name" {
  type    = list(string)
  default = ["alb-web-vh-for-lamp"]
}
variable "alb-http-backend-port" {
  type    = list(string)
  default = ["80"]
}
